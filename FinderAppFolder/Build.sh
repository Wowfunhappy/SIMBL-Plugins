...
PLUGIN_NAME="FixFinderApplicationsFolder"
VERSION=$(date +%Y.%m.%d)
...
# Compile the plugin
clang -dynamiclib -arch i386 -arch x86_64 -mmacosx-version-min=10.6 -framework Cocoa -framework Carbon -I./ZKSwizzle -o "${BUILD_DIR}/${PLUGIN_NAME}" "${PLUGIN_NAME}.m" "ZKSwizzle/ZKSwizzle.m"
